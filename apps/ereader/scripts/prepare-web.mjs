...
if (!parts.length) throw new Error('No packed Mobile E-reader source parts found');
...
console.log(`Prepared Mobile E-reader web source from ${parts.length} packed parts`);
